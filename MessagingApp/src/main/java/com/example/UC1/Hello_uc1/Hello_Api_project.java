...
public class Hello_Api_project {
    ...
    @PutMapping("/query/{firstName}")
    public String sayHy(@PathVariable String firstName, @RequestParam(value = "lastName") String lastName )
    {

        return "Hello "+firstName+" "+lastName+" From BridgeLabz";
        //http://localhost:8080/api/query/Mark?lastName=Taylor
    }
